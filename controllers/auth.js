...
exports.googleLogin = (req, res) => {
	...
	console.log(req)
	return res.status(200).cookie('token', token, {sameSite:'cross-site', domain:'https://competent-saha-d69324.netlify.app', maxAge:5*3600*1000}).redirect(process.env.REDIRECT);
